...
$cartResult = pg_query($conn, "SELECT SUM(quantity) as total_quantity FROM carts");
...
<body class="bg-gray-200">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <form method="post" action="logout.php">
                    <button type="submit" class="bg-red-500 hover:bg-red-700 text-white px-4 py-2 rounded">Log Out</button>
                </form>
            </div>
        </div>
    ...
    <div id="addProductModal" class="fixed z-10 inset-0 overflow-y-auto bg-black bg-opacity-50 hidden">
